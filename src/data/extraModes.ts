...
export const EXTRA_MODES: ModeGuitar[] = [
  ...
  // MODES JAPONAIS
  {
    ...
    seventh: "min7",
    description:
      "La gamme hirajoshi, pilier de la musique traditionnelle japonaise, transporte immédiatement l’auditeur dans un univers sonore sobre et contemplatif. Elle évoque un exotisme méditatif, une certaine retenue et une élégance discrète typiques de l’esthétique japonaise. Utilisée principalement pour le koto ou le shamisen, elle met l’accent sur l’ornementation et les silences valorisés par la philosophie du ‘ma’. Sa structure pentatonique particulière, mariant secondes majeures et tierces mineures, offre une tension légère et subtile. L’hirajoshi représente la quintessence de l’équilibre entre simplicité apparente et raffinement expressif, caractéristique de l’art nippon. Note 12-TET : Bien que ces gammes pentatoniques s'accommodent raisonnablement du tempérament égal, la pratique instrumentale authentique (koto, shamisen, shakuhachi) fait appel à des inflexions de hauteur subtiles — vibrato d'une demi-position, glissando, microvibration — inexprimables par des demi-tons fixes.",
    culture: "Japonaise",
  ...
  // GAMMES ETHNIQUES ET FOLKLORIQUES
  {
    ...
    seventh: "maj7",
    description:
      "Le maqam hijaz, parfois appelé mode arabe, est défini par l’écart d’un ton et demi entre sa seconde mineure et sa tierce majeure, créant une tension orientale typique. Il évoque immédiatement les paysages désertiques, l’appel du muezzin et la richesse émotionnelle de la culture moyen-orientale. Fondamental dans la musique arabe, turque et séfarade, il se décline en de multiples variantes régionales. Sa seconde augmentée distinctive traduit musicalement la chaleur et la passion de ces régions, offrant au chanteur ou à l’instrumentiste des possibilités ornementales foisonnantes. Le hijaz illustre l’héritage culturel et spirituel profondément ancré dans l’Orient méditerranéen, où musique et poésie s’entremêlent depuis des siècles. Note 12-TET : Dans sa tradition d'origine, ce maqam repose sur des quarts de ton et des micro-intervalles inexprimables en tempérament égal à 12 sons. Les intervalles indiqués sont des approximations tempérées ; dans la pratique authentique, chaque degré est une entité vivante, modulé dynamiquement selon l'émotion (tarab) et le rang mélodique.",
