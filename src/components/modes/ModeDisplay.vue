...
<template>
  <div>
    <div>
      <Tab v-if="currentMode" isScale :key="currentMode.name" :midiList="modeMidiNotes" matchType="multiple"
        :tabLength="tabLength" :visibleStart="visibleStart" :visibleEnd="visibleEnd" @click="selectMode(currentMode)"
