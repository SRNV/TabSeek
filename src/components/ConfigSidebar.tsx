...
import { useUIStore, routePanels, type PanelId } from '../composables/useUIState'
...
export default function ConfigSidebar() {
  ...
  const availablePanels: PanelId[] = routePanels[location.pathname] ?? []

  return (
    <aside className="config-sidebar">
      {availablePanels.includes('notes') && (
        <button
      ...
      {availablePanels.includes('modes') && (
        <button
      ...
      {availablePanels.includes('chords') && (
        <button
